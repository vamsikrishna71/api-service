<div class="card-body p-0">
    ...
    <div class="form-group">
        ...
        <div class="mb-6">
            ...
            <div class="fw-semibold text-muted fs-7 d-block lh-1">Enjoy Dark &amp; Light modes.
                <a class="fw-semibold" href="<?php echo e(theme()->getPageUrl('documentation/getting-started/dark-mode')); ?>" target="_blank">See docs</a></div>
        </div>
        <!--end::Heading-->
        <!--begin::Options-->
        <div class="row" data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input" data-kt-initialized="1">
            ...
            <div class="col-6">
                ...
                <label class="form-check-image form-check-success">
                    ...
                    <div class="form-check-wrapper">
                        <img src="<?php echo e(asset(theme()->getMediaUrlPath() . 'misc/layout/light.png')); ?>" class="mw-100" alt="">
                    </div>
                    <!--end::Image-->
                    <!--begin::Check-->
            ...
            <div class="col-6">
                ...
                <label class="form-check-image form-check-success">
                    <!--begin::Image-->
                    <div class="form-check-wrapper">
                        <img src="<?php echo e(asset(theme()->getMediaUrlPath() . 'misc/layout/dark.png')); ?>" class="mw-100" alt="">
                    </div>
                    <!--end::Image-->
                    <!--begin::Check-->
                    <div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
    ...
    <div class="form-group d-flex flex-stack">
        ...
        <div class="d-flex flex-column">
            ...
            <div class="fs-7 fw-semibold text-muted">Change Language Direction.
                <a class="fw-semibold" href="<?php echo e(theme()->getPageUrl('documentation/getting-started/rtl')); ?>" target="_blank">See docs</a></div>
        </div>
        <!--end::Heading-->
        <!--begin::Option-->
        <div class="d-flex justify-content-end">
            ...
            <div class="form-check form-check-custom form-check-solid form-check-success form-switch">
                ...
                <input class="form-check-input w-45px h-30px" type="checkbox" value="true" name="layout-builder[rtl]" id="kt_builder_rtl" <?php echo e(isRTL() ? 'checked="checked"' : ''); ?>>
                <!--begin::Label-->
    ...
    <div class="form-group">
        ...
        <div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])" data-kt-initialized="1">
            ...
            <div class="col-6">
                <!--begin::Option-->
                <label class="form-check-image form-check-success <?php echo e(isDarkSidebar() ? 'checked="checked"' : ''); ?>">
                    <!--begin::Image-->
                    <div class="form-check-wrapper">
                        <img src="<?php echo e(asset(theme()->getMediaUrlPath() . 'misc/layout/dark-sidebar.png')); ?>" class="mw-100" alt="">
                    </div>
                    <!--end::Image-->
                    <!--begin::Check-->
                    <div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
                        <input class="form-check-input" type="radio" checked="checked" value="dark-sidebar" name="layout-builder[layout]" <?php echo e(isDarkSidebar() ? 'checked="checked"' : ''); ?>>
                        <!--begin::Label-->
            ...
            <div class="col-6">
                ...
                <label class="form-check-image form-check-success" <?php echo e(!isDarkSidebar() ? 'checked="checked"' : ''); ?>>
                    <!--begin::Image-->
                    <div class="form-check-wrapper">
                        <img src="<?php echo e(asset(theme()->getMediaUrlPath() . 'misc/layout/light-sidebar.png')); ?>" class="mw-100" alt="">
                    </div>
                    <!--end::Image-->
                    <!--begin::Check-->
                    <div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
                        <input class="form-check-input" type="radio" value="light-sidebar" name="layout-builder[layout]" <?php echo e(!isDarkSidebar() ? 'checked="checked"' : ''); ?>>
                        <!--begin::Label-->
...
<?php /**PATH C:\xampp\htdocs\Metro\resources\views/partials/layout-builder/drawer/__form.blade.php ENDPATH**/ ?>