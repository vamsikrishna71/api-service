        ...
        <?php foreach($items as $item):?>
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <div class="d-flex flex-column">
                    <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold"><?php echo e($item['title']); ?></a>
                    <span class="fs-7 text-muted fw-bold"><?php echo e($item['number']); ?></span>
                </div>
                <!--end::Title-->
            </div>
            <!--end::Item-->
...
<!--end::Recently viewed-->
<?php /**PATH C:\xampp\htdocs\Metro\resources\views/partials/search/partials/_main.blade.php ENDPATH**/ ?>