...
<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item align-items-stretch ms-1 ms-lg-3">
        <?php echo $__env->make('partials/search/_dropdown', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!--end::Search-->
    <!--begin::Activities-->
...
<!--end::Navbar-->
<?php /**PATH C:\xampp\htdocs\Metro\resources\views/layout/demo1/partials/header/_navbar.blade.php ENDPATH**/ ?>