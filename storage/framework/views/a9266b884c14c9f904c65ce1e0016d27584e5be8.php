...
<div
	...
	<div class="card border-0 shadow-none rounded-0 w-100">
		<?php echo e(theme()->getView('partials/layout-builder/drawer/__header')); ?>
		...
		<div class="card-body position-relative" id="kt_app_layout_builder_body">
			...
			<div id="kt_app_settings_content"
				...
				<!--begin::Form-->
				<form class="form" method="POST" id="kt_app_layout_builder_form" action="<?php echo e(route('layout-builder.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" id="kt_app_layout_builder_action" name="layout-builder[action]"/>
					<?php echo e(theme()->getView('partials/layout-builder/drawer/__form')); ?>
		...
		<?php echo e(theme()->getView('partials/layout-builder/drawer/__footer')); ?>
...
<?php echo e(theme()->getView('partials/layout-builder/drawer/__toggle')); ?>

<?php /**PATH C:\xampp\htdocs\Metro\resources\views/partials/layout-builder/drawer/_main.blade.php ENDPATH**/ ?>