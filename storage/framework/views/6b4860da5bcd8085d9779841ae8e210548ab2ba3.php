...
style="background-image:url('<?php echo e(asset(theme()->getMediaUrlPath() . 'misc/layout/header-bg.jpg')); ?>')">
    <!--begin::Card title-->
    <h3 class="card-title fs-3 fw-bold text-white flex-column m-0">
        <?php echo e(theme()->getProductName()); ?> Builder
    ...
    <div class="card-toolbar">
        <button type="button" class="btn btn-sm btn-icon bg-white bg-opacity-25 btn-color-white p-0 w-20px h-20px rounded-1" id="kt_app_layout_builder_close">
            <?php echo theme()->getSvgIcon("icons/duotune/arrows/arr061.svg", "svg-icon-3"); ?>
...
<!--end::Card header-->
<?php /**PATH C:\xampp\htdocs\Metro\resources\views/partials/layout-builder/drawer/__header.blade.php ENDPATH**/ ?>