...
<div data-kt-search-element="results" class="d-none">
    ...
    <div class="scroll-y mh-200px mh-lg-325px">
        <?php foreach($items as $category => $categoryItems):?>
            ...
            <h3 class="fs-5 text-muted m-0 <?php echo e(($loop > 1 ? 'pt-5' : '')); ?> pb-5" data-kt-search-element="category-title">
            ...
            <?php foreach($categoryItems as $item):?>
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <?php echo theme()->getSvgIcon($item['icon'], "svg-icon-2 svg-icon-primary"); ?>
                        ...
                        <div class="d-flex flex-column">
                            <span class="fs-6 fw-bold"><?php echo e($item['title']); ?></span>
                            <span class="fs-7 fw-bold text-muted"><?php echo e($item['number']); ?></span>
                        </div>
                        <!--end::Title-->
                    </a>
                    <!--end::Item-->
                ...
                <?php if ($category == 'customers'):?>
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="<?php echo e(asset(theme()->getMediaUrlPath() . $item['logo'])); ?>" alt=""/>
                            </span>
                        </div>
                        <!--end::Symbol-->
                        ...
                        <div class="d-flex flex-column justify-content-start fw-bold">
                            <span class="fs-6 fw-bold"><?php echo e($item['title']); ?></span>
                            <span class="fs-7 fw-bold text-muted"><?php echo e($item['category']); ?></span>
                        </div>
                        <!--end::Title-->
                    </a>
                    <!--end::Item-->
                ...
                <?php if ($category == 'users'):?>
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="<?php echo e(asset(theme()->getMediaUrlPath() . $item['avatar'])); ?>" alt=""/>
                        </div>
                        <!--end::Symbol-->

                        <!--begin::Title-->
                        <div class="d-flex flex-column justify-content-start fw-bold">
                            <span class="fs-6 fw-bold"><?php echo e($item['name']); ?></span>
                            <span class="fs-7 fw-bold text-muted"><?php echo e($item['position']); ?></span>
                        </div>
                        <!--end::Title-->
                    </a>
                    <!--end::Item-->
...
<!--end::Recently viewed-->
<?php /**PATH C:\xampp\htdocs\Metro\resources\views/partials/search/partials/_results.blade.php ENDPATH**/ ?>