...
return array(
    ...
    'documentation' => array(
        ...
        // Changelog
        array(
            'title'            => 'Changelog <span class="px-2 badge badge-changelog badge-light-danger bg-hover-danger text-hover-white fw-bold fs-9 ms-2">v'.theme()->getVersion().'</span>',
